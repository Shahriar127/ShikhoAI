...
export default function App() {
  ...
  const handleSolve = async () => {
    ...
    try {
      ...
      console.warn("Express backend is unavailable (Vercel Serverless / Static Mode). Running high-fidelity client-side tutorial simulation.");
      
      const query = finalPrompt.toLowerCase();
      let simulatedResponse = "";
      
      if (imageFile) {
        simulatedResponse = `### 📚 [সার্ভারলেস সিমুলেটর মোড] টেক্সটবুক ইমেজ বিশ্লেষণ (OCR Active)
...
*অনুরোধ:* এই উত্তরটি একটি সার্ভারলেস সিমুলেটেড টিউটোরিয়াল। আসল এআই মডেলের সাথে সরাসরি সংযোগের জন্য অনুগ্রহ করে Localhost অথবা Cloud Run এ Express ব্যাকএন্ড সার্ভারটি চালু রাখুন।`;
      } else if (query.includes("সালোকসংশ্লেষণ") || query.includes("photosynthesis") || query.includes("saloksongshleshon")) {
...
*দ্রষ্টব্য: এটি চমৎকার বাংলায় ব্যাখ্যা করা হয়েছে।*`;
      } else if (query.includes("মহাকর্ষ") || query.includes("gravity") || query.includes("mohakorsho")) {
...
আপনার ওজন চাঁদে পৃথিবীর ওজনের মাত্র **১/৬ ভাগ** হবে, কারণ চাঁদের মহাকর্ষ বল পৃথিবীর চেয়ে অনেক কম!`;
      } else if (query.includes("solve") || query.includes("সমাধান") || query.includes("2x")) {
        simulatedResponse = `### 🧬 গাণিতিক সমীকরণ সমাধান (Equation Solver)

আমরা আপনার গাণিতিক সমীকরণটি অত্যন্ত সহজ ধাপে বিশ্লেষণ করেছি:

#### 📝 সমীকরণ:
2x + 5 = 15

#### 📐 ধাপে ধাপে সমাধান:
1. **ধাপ ১:** সমীকরণের বামপাশ থেকে ৫ বিয়োগ করুন বা ডানপাশে নিয়ে যান:
   2x = 15 - 5
   2x = 10
2. **ধাপ ২:** এখন x এর মান বের করার জন্য উভয় পক্ষকে ২ দিয়ে ভাগ করুন:
   x = 10 / 2
   x = 5
...
**x = 5**`;
        ...
        simulatedResponse = `### 🎓 ShikhoAI শিক্ষামূলক অ্যাসিস্ট্যান্ট (সার্ভারলেস মোড)
আপনার প্রশ্ন: **"${finalPrompt}"**
...
*(আসল এআই মডেলের সাথে সরাসরি সংযোগের জন্য অনুগ্রহ করে Localhost অথবা Cloud Run এ Express ব্যাকএন্ড সার্ভারটি চালু রাখুন)*`;
      }

      setResultText(simulatedResponse);
      setIsSimulated(true);
      setIsOcrDetected(!!imageFile);
    } finally {
      setLoading(false);
